    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(StudentMainActivity.this,"Refreshing...",Toast.LENGTH_SHORT).show();
                // Firebase data reference
                DatabaseReference parkingSlot = FirebaseDatabase.getInstance().getReference().child("Database").child(lab);
